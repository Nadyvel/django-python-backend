...
# FOR SECOND REGISTRATION STEP (ignore for now)
...
# FOR THE FIRST REGISTRATION STEP
class RegistrationSerializer(serializers.Serializer):
    email = serializers.EmailField(label='Registration E-Mail Address', validators=[email_does_not_exist])

    # overwriting default behaviour because we need to create not one, but TWO objects
    def save(self, validated_data):
        ...
        # creates the registration profile
        ...
        #####
        # IGNORE COMMENTED OUT EMAIL STUFF for now.
